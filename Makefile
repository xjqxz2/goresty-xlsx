...
windows:
	...
	CGO_ENABLED=1 GOOS=windows GOARCH=amd64 CC=i686-w64-mingw32-gcc CXX=i686-mingw32-g++ go build -buildmode=c-shared -ldflags "-s -w" -o $(shell pwd)/bin/libshex_x86.dll $(shell pwd)/main

...
linux:
	...
	ls $(shell pwd)/bin/linux_x64-86
	tar -cf $(shell pwd)/bin/linux_x64_86.tar.gz -C $(shell pwd)/bin linux_x64-86
windows:
	...
	tar -cf $(shell pwd)/bin/windows_x64-86.tar.gz -C $(shell pwd)/bin windows_x64-86
	...
	tar -cf $(shell pwd)/bin/windows_x86.tar.gz -C $(shell pwd)/bin windows_x86

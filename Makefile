...
linux:
	...
	tar -cf $(shell pwd)/bin/linux_x64_84.tar.gz $(shell pwd)/bin/linux_x64-86/
windows:
	...
	tar -cf $(shell pwd)/bin/windows_x64-86.tar.gz $(shell pwd)/bin/windows_x64-86/
	ls $(shell pwd)/bin/windows_x64-86/
	...
	tar -cf $(shell pwd)/bin/windows_x86.tar.gz $(shell pwd)/bin/windows_x86/
	ls $(shell pwd)/bin/windows_x64-86/

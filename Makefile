...
linux:
	...
	tar czf $(shell pwd)/bin/linux_x64_84.tar.gz -C $(shell pwd)/bin/linux_x64-86
windows:
	...
	tar czf windows_x64-86.tar.gz -C $(shell pwd)/bin/windows_x64-86
	...
	tar czf $(shell pwd)/bin/windows_x86.tar.gz -C $(shell pwd)/bin/windows_x86
